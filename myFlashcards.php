...
<div class="container mt-5" >
		...
		<h1 class="text-dark card-title text-center">My Sets</h1>				
						...
						<div class="col mb-4">
							<div class="card text-white bg-secondary">
								...
								<div class="card-body">
									...
									<div class="row mb-2">	
										<button type="submit" class="col-8 btn btn-fix btn-outline-light mx-auto" name="flash<?=$w['id_flash']?>">
											Flash View</button>
									</div>
									<div class="row mb-2">
										<button type="submit" class="col-8 btn btn-fix btn-outline-light mx-auto" name="startFlash<?=$w['id_flash']?>">
											Start Flashcard</button>	
									</div>
					
									<div class="row">	
										<button type="submit" class="col-8 btn btn-fix btn-outline-light mx-auto" name="ACode<?=$w['id_flash']?>">
